        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div className="max-w-xl">
            ...
            <p className="font-sans text-brand-dark/65 text-base leading-relaxed">
              Download the AirWallet mobile app and your first wash is on us. Pay
              through the app on any machine — no coins, no hassle.
            </p>
          </div>
          ...
          <div className="shrink-0">
            ...
            <p className="font-sans text-xs text-brand-dark/40 mt-3 tracking-wide">
              First wash free with in-app payment
            </p>
          </div>
        </div>
      </div>
