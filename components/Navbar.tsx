  ...
  return (
    ...
    >
      <nav className={`max-w-7xl mx-auto px-6 h-16 flex items-center justify-between border-b ${borderColor}`}>
        ...
        <a
          href="tel:9092487305"
          className={`hidden md:flex items-center gap-2 font-sans font-semibold text-sm tracking-wide transition-opacity hover:opacity-70 ${textColor}`}
        >
          <svg
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-brand-dark/10 shadow-md">
          <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col gap-4">
            ...
            <a
              href="tel:9092487305"
              className="font-sans font-semibold text-sm text-brand-dark hover:text-brand-blue transition-colors mt-2 pt-4 border-t border-brand-dark/10"
            >
              (909) 248-7305
            </a>
          </div>
