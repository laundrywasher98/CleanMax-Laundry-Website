...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Lavandería comercial con recogida y entrega en Pomona y el Inland Empire. $65 fijos de recolección, entrega al siguiente día estándar. CleanMax Laundry — un equipo familiar. Llame al (909) 248-7305.",
