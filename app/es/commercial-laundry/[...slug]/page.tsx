...
export async function generateMetadata({
  ...
  return buildMetadata({
    ...
    description: `Lavandería comercial para ${industry.nameEs} en ${city.name}, CA — ${industry.itemsEs}. $35 fijos de recogida, entrega al siguiente día, equipo bilingüe. (909) 248-7305.`,
